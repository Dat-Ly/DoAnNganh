...
CREATE TABLE `medicalhistory` (
  `patient_name` char(20) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `illness` char(20) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `medicine_taken` char(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `user` (
  ...
  `fullname` char(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  `user_role` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-07-23 19:24:12
